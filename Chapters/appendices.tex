\chapter{Appendix A}
This appendix documents the use of generative AI tools during the completion of this projects. AI tools were used in a supporting manner only, mainly for improving clarity and or structure. All technical decisions, implmentations, simulations, and interpretatins were completed without the use of generative AI.


\section{Example AI prompts used}
The following list provides examples of prompts during the projects. Some prompts were excluded when they were substantially ismilar to others or if they did not contribute to the project. 

\begin{itemize}
    \item Show me this paragraph rewritten in a more formal tone suitable for a thesis
    \item Sumnmarise this section without altering any technical informaiton
    ...
    \item Restrucutre this section to better show the key points and results 
...
Aside from LLM inputs on rafactoring code or changing comments, no AI was used to generate or create code from scratch. 
\begin{itemize}
