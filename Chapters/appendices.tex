\chapter{Appendix A}
This appendix documents the use of generative AI tools during the completion of this projects. AI tools were used in a supporting manner only, mainly for improving clarity and or structure. All technical decisions, implementations, simulations, and interpretations were completed without the use of generative AI.


\section{Example AI prompts used}
The following list provides examples of prompts during the projects. Some prompts were excluded when they were substantially similar to others or if they did not contribute to the project. 
