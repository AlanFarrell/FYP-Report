...
\end{figure}
While coverage is timeivarying, the achievable downlink capacity during coverage periods remains consistently broadband grade, exceeding 320 Mbps across most midland regions.
...
Figure \ref{fig:OneWebCoverage_mbps} shows the average downlink capacity when coverage is available. The mean capacity is 31.93 Mbps, with values ranging from 29.26 Mbps, to 34.60 mbps across Ireland. While these data rates are sufficient for baseline broadband services, they are significantly lower than Starlink's results, reflecting OneWeb's higher altitude. 
...
\begin{figure}[h!]
    ...
    \caption{Average downlink capacity for Kuiper over Ireland THIS FIGURE NEEDS TO BE REMADE }
